...
def index(request):
    ...
    return render_to_response('templates/index.html', RTR_DICT, context_instance=RequestContext(request))
...
def galerias(request):
    ...
    return render_to_response('galeria/templates/galeria.html', RTR_DICT, context_instance=RequestContext(request))

def missao(request):
    texto = Texto.objects.filter(titulo='missao')
    RTR_DICT['texto'] = texto[0]
    return render_to_response('galeria/templates/galeria_missao.html', RTR_DICT, context_instance=RequestContext(request))

def historia(request):
    texto = Texto.objects.filter(titulo='historia')
    RTR_DICT['texto'] = texto[0]
    return render_to_response('galeria/templates/galeria_historia.html', RTR_DICT, context_instance=RequestContext(request))
...
def curriculum(request):
    ...
    RTR_DICT['anos'] = anos
    return render_to_response('galeria/templates/galeria_curriculum.html', RTR_DICT, context_instance=RequestContext(request))
...
def curriculum_ano(request, evento_ano):
    ...
    return render_to_response('galeria/templates/galeria_curriculum_anos.html', RTR_DICT, context_instance=RequestContext(request))
    
def equipa(request):
    texto = Texto.objects.filter(titulo='estrutura')
    RTR_DICT['texto'] = texto[0]
    return render_to_response('galeria/templates/galeria_equipa.html', RTR_DICT, context_instance=RequestContext(request))
...
def acervo(request):
    ...
    return render_to_response('galeria/templates/galeria_acervo.html', RTR_DICT, context_instance=RequestContext(request))
...
def acervo_artist(request, artist_id):
    ...
    return render_to_response('galeria/templates/galeria_acervo_artista.html', {'artista': artista, 'telas': telas, 'acervo_list':acervo_list}, context_instance=RequestContext(request))
...
def acervo_detalhe(request, obra_id,  artist_id):
    ...
    return render_to_response('galeria/templates/acervo_detalhe.html', {'obra': obra, 'telas': telas, 'tecnicas': tecnicas, 'materiais': materiais}, context_instance=RequestContext(request))

def visita(request):
    return render_to_response('galeria/templates/galeria_visita.html', RTR_DICT, context_instance=RequestContext(request))

def agenda(request):
    return render_to_response('galeria/templates/galeria_agenda.html', RTR_DICT, context_instance=RequestContext(request))
...
def premios(request):
    ...
    return render_to_response('galeria/templates/galeria_premios.html', RTR_DICT, context_instance=RequestContext(request))
...
def detail(request, aniversario_id):
    ...
    return render_to_response('galeria/templates/premios_detalhe.html', RTR_DICT, context_instance=RequestContext(request))
...
def premiados(request, aniversario_id):
    ...
    premios = Premio.objects.filter(aniversario=aniversario_id).order_by('nome')
    RTR_DICT['premios'] = premios
    return render_to_response('galeria/templates/premiados.html', RTR_DICT, context_instance=RequestContext(request))
...
def trofeu(request, aniversario_id):
    ...
    return render_to_response('galeria/templates/trofeu.html', {'aniversario': aniversario, 'trofeu': trofeu, 'telas': telas, 'tecnicas': tecnicas, 'materiais': materiais}, context_instance=RequestContext(request))
