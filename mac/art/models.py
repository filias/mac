...
class Artist(models.Model):
    ...
    bio = models.FileField(
        upload_to="biografias/", null=True, blank=True, db_column="biografia"
    )
    art_type = models.ManyToManyField("ArtType", db_table="artistas_artista_tipo")
    canvases = models.ManyToManyField(
        "Canvas", blank=True, db_table="artistas_artista_telas"
    )
...
class ArtWork(models.Model):
    ...
    art_work_type = models.ForeignKey(
        "ArtType", on_delete=models.CASCADE, db_column="tipo_id"
    )
    techniques = models.ManyToManyField(
        "ArtTechnique", blank=True, db_table="artistas_obra_tecnicas"
    )
    ...
    materials = models.ManyToManyField(
        "ArtMaterial", blank=True, db_table="artistas_obra_materiais"
    )
...
class ArtTechnique(models.Model):
    ...
    category = models.ForeignKey(
        "ArtType", on_delete=models.CASCADE, db_column="categoria_id"
    )
