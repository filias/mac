...
def index(request):
    ...
    return render_to_response('publicacoes/templates/publicacoes.html', RTR_DICT, context_instance=RequestContext(request))
...
def newsletters(request, select):
    ...
    return render_to_response('publicacoes/templates/publicacoes_newsletters.html', RTR_DICT, context_instance=RequestContext(request))
...
def catalogos(request, select):
    ...
    return render_to_response('publicacoes/templates/publicacoes_catalogos.html', RTR_DICT, context_instance=RequestContext(request))
...
def monografias(request, select):
    ...
    return render_to_response('publicacoes/templates/publicacoes_monografias.html', RTR_DICT, context_instance=RequestContext(request))
...
def imprensa(request, select):
    ...
    return render_to_response('publicacoes/templates/publicacoes_imprensa.html', RTR_DICT, context_instance=RequestContext(request))
...
def critica(request, select):
    ...
    return render_to_response('publicacoes/templates/publicacoes_criticas.html', RTR_DICT, context_instance=RequestContext(request))
