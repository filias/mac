...
def passadas_ano(request, exposicao_ano):
    ...
    return render(request, 'exposicoes/templates/exposicoes_passadas_ano.html', RTR_DICT)
...
def detail(request, exposicao_id):
    ...
    return render(request, 'exposicoes/templates/exposicoes_detalhe.html', {'actual': actual, 'exposicao': exposicao, 'telas': telas, 'fotos': fotos, 'galerias': galerias, 'artistas': artistas, 'obras': obras})
...
def obras(request, exposicao_id):
    ...
    obras = exposicao.obras.all().order_by('-ano')
    telas = exposicao.telas.all()
    return render(request, 'exposicoes/templates/exposicoes_obras.html', {'exposicao': exposicao, 'obras': obras, 'telas': telas})
...
def obra_detalhe(request, exposicao_id, obra_id):
    ...
    return render(request, 'exposicoes/templates/obra_detalhe.html', {'obra': obra, 'telas': telas, 'tecnicas': tecnicas, 'materiais': materiais, 'exposicao': exposicao})
