    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "bio_short_pt",
                    models.TextField(blank=True, db_column="bio_resumo", null=True),
                ),
                (
                    "bio_short_en",
                    models.TextField(blank=True, db_column="bio_resumo_en", null=True),
                ),
                (
                    "bio",
                    models.FileField(
                        ...
                        db_column="biografia",
                        null=True,
                        upload_to="biografias/",
                    ),
                ),
                (
                    "mac_artist",
                    models.BooleanField(db_column="artista_mac", default=False),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "height",
                    models.IntegerField(blank=True, db_column="altura", null=True),
                ),
                (
                    "width",
                    models.IntegerField(blank=True, db_column="largura", null=True),
                ),
                (
                    "depth",
                    models.IntegerField(
                        blank=True, db_column="profundidade", null=True
                    ),
                ),
                (
                    "state",
