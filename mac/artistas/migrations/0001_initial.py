    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "biografia",
                    models.FileField(null=True, upload_to=b"biografias/", blank=True),
                ),
                ...
                (
                    "telas",
                    models.ManyToManyField(to="geral.Tela", null=True, blank=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "autor",
                    models.ForeignKey(to="artistas.Artista", on_delete=models.CASCADE),
                ),
                (
                    "foto",
                    models.ForeignKey(
                ...
                (
                    "materiais",
                    models.ManyToManyField(to="geral.Material", null=True, blank=True),
                ),
                (
                    "tecnicas",
                    models.ManyToManyField(to="geral.Tecnica", null=True, blank=True),
                ),
