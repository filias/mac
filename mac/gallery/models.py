...
class Gallery(models.Model):
    ...
    zip_code = models.CharField(max_length=8, null=True, blank=True, db_column="cod_postal")
    phone = models.CharField(max_length=13, null=True, blank=True, db_column="telefone")
    email = models.EmailField(max_length=75, null=True, blank=True)
    opening_times = models.CharField(max_length=200, null=True, blank=True, db_column="horario")
...
class Exhibition(models.Model):
    ...
    exhibition_type = models.CharField(max_length=1, choices=EXHIBITION_TYPE_CHOICES, blank=True, db_column="tipo")
    art_type = models.ManyToManyField("art.ArtType", db_table="exposicoes_exposicao_tipo_arte")
    description = models.TextField(null=True, blank=True, db_column="descricao")
    ...
    galleries = models.ManyToManyField("Gallery", db_table="exposicoes_exposicao_galerias")
    artists = models.ManyToManyField("art.Artist", blank=True, db_table="exposicoes_exposicao_artistas")
    art_works = models.ManyToManyField("art.ArtWork", blank=True, db_table="exposicoes_exposicao_obras")
    fotos = models.ManyToManyField("Foto", blank=True, db_table="exposicoes_exposicao_fotos")
    ...
    invitation = models.FileField(upload_to="convites/", null=True, blank=True, db_column="convite")
    press_release = models.FileField(upload_to="press_releases/", null=True, blank=True)
    canvases = models.ManyToManyField("art.Canvas", db_table="exposicoes_exposicao_telas")
...
class Awardee(models.Model):
    ...
    profession = models.CharField(max_length=50, null=True, blank=True, db_column="profissao")
...
class Anniversary(models.Model):
    ...
    description = models.TextField(null=True, blank=True, db_column="descricao")
    trophy = models.ForeignKey("art.ArtWork", null=True, blank=True, on_delete=models.CASCADE, db_column="trofeu_id")
    invitation = models.FileField(upload_to="convites/", null=True, blank=True, db_column="convite")
    catalog = models.FileField(upload_to="catalogos/", null=True, blank=True, db_column="catalogo")
    fotos = models.ManyToManyField("Foto", blank=True, db_table="galeria_aniversario_fotos")
...
class Award(models.Model):
    ...
    awardee = models.ForeignKey(
        "Awardee", null=True, blank=True, on_delete=models.CASCADE, db_column="premiado_id"
    )
    anniversary = models.ForeignKey(
        "Anniversary", null=True, blank=True, on_delete=models.CASCADE, db_column="aniversario_id"
    )
...
class Publication(models.Model):
    ...
    artist = models.ForeignKey(
        "art.Artist", null=True, blank=True, on_delete=models.CASCADE, db_column="artista_id"
    )
    publication_type = models.CharField(max_length=10, choices=PUBLICATION_TYPE_CHOICES, db_column="tipo")
    date = models.DateField(null=True, blank=True, db_column="data")
    description = models.TextField(null=True, blank=True, db_column="descricao")
    description_en = models.TextField(null=True, blank=True, db_column="descricao_en")
    file = models.FileField(
        upload_to="publicacoes/", max_length=200, null=True, blank=True, db_column="ficheiro"
    )
...
class Snippet(models.Model):
    ...
    image = models.ImageField(upload_to="inicial/", null=True, blank=True, db_column="imagem")
    text = models.TextField(null=True, blank=True, db_column="texto")
    text_en = models.TextField(null=True, blank=True, db_column="texto_en")
