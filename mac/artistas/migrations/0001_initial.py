    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.ForeignKey(related_name='foto', blank=True, to='geral.Foto', null=True)),
                ('foto_obra', models.ForeignKey(related_name='foto_obra', blank=True, to='geral.Foto', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autor', models.ForeignKey(to='artistas.Artista')),
                ...
                ('tipo', models.ForeignKey(to='geral.Tipo')),
            ],
            options={
                'ordering': ['autor', '-ano'],
                'verbose_name': 'Obra',
